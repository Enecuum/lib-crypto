...
Napi::Object VerifyTate(const Napi::CallbackInfo& info) {
	...
	ExtensionField::Element bb = tatePairing(MPK_fq, Q_Fq, S_fq, *ecurve->E_Fq);

	ExtensionField::Element cc = tatePairing(S1_fq, H_fq, S_fq, *ecurve->E_Fq);

	std::string strEta = "";
